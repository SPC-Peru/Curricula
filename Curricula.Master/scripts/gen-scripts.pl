...
{	
	...
	open(OUT, ">$current_inst_file") or Util::halt("generate_institution: $current_inst_file does not open\n");
        my $output_txt = "";
	...
	Util::write_file(Common::get_template("OutDir")."/tex/current-institution.tex", $output_txt);
