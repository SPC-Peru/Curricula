...
Capítulo \ref{chap:cs-estudio-de-mercado}. Este estudio arrojó datos interesantes con 
relaciòn a la percepciòn y la necesidad empresarial de este perfil profesional.
}
...
Un análisis más detallado del mercado junto con una encuesta a empresarios es presentada en el 
Capítulo \ref{chap:cs-estudio-de-mercado}. Este estudio arrojó datos interesantes con relaciòn 
a la percepciòn y la necesidad empresarial de este perfil profesional.
...
El Capítulo \ref{chap:BOK}, muestra los 14 grupos que forman el centro del conocimiento de la 
Ciencia de la Computación, indicando los tópicos y objetivos cubiertos por cada uno de los temas, 
...
El Capítulo \ref{chap:syllabi} contiene informaci[on detallada para cada uno de los cursos 
...
\OnlyUCSP{En el Capítulo \ref{chap:equivalence} se presentan las tablas de equivalencias con otros 
planes curriculares.}
