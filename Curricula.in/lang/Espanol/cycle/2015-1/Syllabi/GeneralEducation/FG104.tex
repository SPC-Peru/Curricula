...
\begin{unit}{}{Introducción, Nociones, División de la Filosofía}{Melendo,Pieper,ReydeCastro2010}{15}{C24}
\begin{topics}
...
\begin{learningoutcomes}
	\item Introducir al alumno a la naturaleza de la filosofía y a su importancia para la vida [\Usage].
	\item Introducir las nociones esenciales de la filosofía [\Usage].
	\item Que el alumno comprenda el alcance de la filosofía y su diferenciación con otras disciplinas [\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{Antropología, Gnoseología, Ética}{ReydeCastro2010}{15}{C24}
\begin{topics}
...
\begin{learningoutcomes}
	\item Introducir al alumno a las nociones y principios fundamentales de la Antropología Filosófica [\Usage].
	\item Introducir al alumno a las nociones y principios fundamentales de una Teoría del Conocimiento general y científico que de hecho de razón de las acciones humanas de actuar en base a ese conocimiento, es decir, un teoría realista moderada [\Usage].
	\item Introducir al alumno a las nociones y principios fundamentales de la Ética como reflexión sobre la libertad y felicidad humana en relación con la realidad [\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{Metafísica}{ReydeCastro2010,Pieper,JuanPabloA,Chavez2003HistoriaDoctrinas}{15}{C22}
\begin{topics}
...
\begin{learningoutcomes}
	\item Introducir al alumno a las nociones y principios fundamentales de la Metafísica como dimensión inherente a todo cuestionamiento humano sobre la realidad [\Usage].
\end{learningoutcomes}
\end{unit}
