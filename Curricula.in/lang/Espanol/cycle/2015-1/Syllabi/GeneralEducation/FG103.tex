...
\begin{unit}{}{El Universitario}{Sanz,Guardini,Rilke,Marias,Frankl,Fromm}{36}{C22,C24}
\begin{topics}
...
\begin{learningoutcomes}
	...
	\item Descubrir el propio proyecto de vida que responda a sus anhelos y búsqueda de propósito[\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{La Universidad}{JuanPablo,Guardini2,Maldonado,Identidad}{12}{C22,C24}
\begin{topics}
...
\end{topics}
\begin{learningoutcomes}
	\item Identificar y dominar los horizontes y la dinámica de la vida universitaria, particularmente,  los horizontes específicos de la Universidad Católica San Pablo [\Usage].
	\item Descubrir que su tiempo de estancia en la institución constituye un proceso de verdadera formación integral de su persona, intelectual, académica y profesional, y, que, puede desde la Universidad, ofrecer un aporte consistente y responsable ante los desafíos del mundo actual [\Usage].
\end{learningoutcomes}
\end{unit}
