...
\begin{unit}{}{?`Quién es el ser humano?}{GarciaCuadrado,JuanPabloA,Edith,Amengual,ReydeCastro,Lepp63}{6}{C22}
\begin{topics}
...
\begin{learningoutcomes}
	\item Presentar la Antropología Filosófica y Teológica desde una aproximación existencial que considera la distinción entre filosofía y teología, 
	      así como el vínculo entre ambas que nace en la armonía de la fe con la razón [\Usage].
	\item Respuestas a la pregunta por el ser humano [\Usage].
	\item alorar la originalidad de la respuesta cristiana [\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{El hombre en la actualidad}{Lepp63,Rojas,Frankl,Unamuno,Figari04,Buber}{6}{C22}
\begin{topics}
...
\end{topics}
\begin{learningoutcomes}
	\item Analizar la situación del hombre en nuestro tiempo. Considerar en particular el proceso de dimisión de lo humano [\Usage]
\end{learningoutcomes}
\end{unit}
...
\end{topics}
\begin{learningoutcomes}
	\item Mostrar que frente al nihilismo el ser humano es alguien, es persona y tiene un sentido [\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{La persona: unidad bio-psico-espiritual}{Edith,GarciaCuadrado,Lepp63,Wojtyla2}{3}{C22}
\begin{topics}
	\item Soy cuerpo.
...
\end{topics}
\begin{learningoutcomes}
	\item Presentar al hombre como unidad biológica, psíquica y espiritual [\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{Los dinamismos de la persona}{Lepp63,ReydeCastro2}{6}{C22}
\begin{topics}
