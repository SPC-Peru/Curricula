...
\begin{competences}
    ...
    \item \ShowCompetence{C22}{h}
\end{competences}

\begin{unit}{}{La Ética Filosófica}{Lewis, Bourmaud, RodriguezL, AristotelesE}{9}{C21,C22}
\begin{topics}
...
\begin{learningoutcomes}
	\item Presentar una primera noción de la ética y de los problemas relativos a esta rama de la filosofía.[\Familiarity]
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{La acción moral}{SanchezM,Genta}{15}{C21,C22}
\begin{topics}
...
\end{topics}
\begin{learningoutcomes}
	\item Hacer un análisis del acto humano, presentando sus condiciones y especificando su moralidad.[\Familiarity]
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{La vida virtuosa}{Piper,Droste,Lego,StoTomas}{12}{C21,C22}
\begin{topics}
...
\end{topics}
\begin{learningoutcomes}
	\item Presentar el ideal filosófico de la vida virtuosa destacando algunas virtudes fundamentales.[\Familiarity]
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{Lo éticamente correcto y su conocimiento}{ReydeCastro2010,SanchezM,Genta}{9}{C21,C22}
\begin{topics}
...
\begin{learningoutcomes}
	\item Presentar las nociones de recta razón, conciencia moral, y moral natural destacando el conocimiento de la ley moral natural.[\Familiarity]
\end{learningoutcomes}
\end{unit}
