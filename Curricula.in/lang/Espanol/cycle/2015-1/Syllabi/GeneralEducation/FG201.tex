...
\begin{unit}{}{Unidad 1}{Rudolf}{9}{C24}
\begin{topics}
...
\begin{learningoutcomes}
	\item Comprensión de los términos Arte y Estética [\Usage].
	\item Entender a la comunicación, como base en las Artes visuales [\Usage].

\end{learningoutcomes}
\end{unit}

\begin{unit}{}{Unidad 2}{Rudolf}{9}{C24}
\begin{topics}
	\item Introducción.
	\item Historia.
...
\end{topics}
\begin{learningoutcomes}
	\item Conocer y sensibilizar el uso del color [\Usage].
	\item Conocer: Teorías sobre el color y su consecutiva aplicación al entorno [\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{Unidad 3}{Rudolf}{9}{C24}
\begin{topics}
...
\end{topics}
\begin{learningoutcomes}
	\item Desarrollar las diferentes épocas de la Historia Humana; las manifestaciones artísticas y como estas influencian a través de los siglos [\Usage].
	\item Formar modelos de apreciación a través de los conocimientos adquiridos [\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{Unidad 4}{Rudolf}{6}{C24}
\begin{topics}
...
\begin{learningoutcomes}
	\item Conocer las diferentes manifestaciones del Arte durante estos últimos tres milenios y el legado de nuestros antepasados; revalorarlos conociendo su historia y proyectarla al presente y futuro [\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{Unidad 5}{Rudolf}{6}{C24}
\begin{topics}
...
\end{topics}
\begin{learningoutcomes}
	\item Desarrollar un proyecto de investigación grupal, análisis conceptual, técnico, etc. de una obra de un pintor universal con trayectoria [\Usage].
\end{learningoutcomes}
\end{unit}
