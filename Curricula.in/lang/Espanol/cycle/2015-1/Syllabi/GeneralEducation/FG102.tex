...
\begin{unit}{}{Unidad 1}{CHAVEZA,CARRAZCO,GARAYCOCHEA,Pauk,Pimienta,Bernedo,Tapia}{8}{C24}
\begin{topics}
...
\begin{learningoutcomes}
        \item Comprender el  significado de estar en  la universidad, de la exigencia que representa, de los problemas del universitario que se inicia, de las habilidades que debe desarrollar como tal; para fortalecer una actitud comprometida con su ser estudiante.[\Usage]
        \item Conocer y aplicar los criterios para el aparato crítico, para el tratamiento de la información académica.[\Usage]
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{Unidad 2}{CHAVEZA,CARRAZCO,GARAYCOCHEA,Pauk,Pimienta,Bernedo}{8}{C17,C24}
\begin{topics}
...
\end{topics}
\begin{learningoutcomes}
        \item Comprender la necesidad de desarrollar  fortalezas y disposiciones que para el desempeño académico y relacional, en la universidad [\Usage].
        \item Comprender los procesos mentales que se dan en el aprendizaje para evaluar y monitorear el propio proceso de estudiar para aprender [\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{Unidad 3}{CHAVEZA,CARRAZCO,GARAYCOCHEA,Flores,Buzan,Pauk,Pimienta,Bernedo}{8}{C24}
\begin{topics}
...
\end{topics}
\begin{learningoutcomes}
        \item Comprender los procesos para el aprendizaje y la relación entre Conocimiento y Aprendizaje, la  lectura analítica como medio principal para aprender, las leyes del aprendizaje, los pasos o fases del aprendizaje. Optar por el aprendizaje  significativo [\Usage].
        \item Explicar conceptos y ejemplificar situaciones  para el ejercicio de en la capacidad para expresar el conocimiento, con lenguaje adecuado, pertinente de forma oral y escrita [\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{Unidad 4}{CHAVEZA,CARRAZCO,GARAYCOCHEA,Buzan,Pauk,Pimienta,Bernedo}{7}{C24}
\begin{topics}
...
\end{topics}
\begin{learningoutcomes}
        \item Elegir y usar un método de estudio como un conjunto de estrategias, organización  y técnicas de estudio libremente implementado, como consecuencia  de la comprensión del estilo personal de aprendizaje [\Usage].
        \item Usar lenguaje inteligible y adecuado para expresar el conocimiento, con lenguaje adecuado, pertinente de forma oral y escrita [\Usage].
\end{learningoutcomes}
\end{unit}
