...
\begin{unit}{}{La Comunicación y la Lengua}{Cassany, Caceres, Cisneros}{9}{C17,C18}
\begin{topics}
...
\begin{learningoutcomes}
   \item Reconocer, definir y aplicar la naturaleza de la Comunicación como factor fónico de las relaciones sociales y profesionales [\Usage].
   \item Reconocer y apreciar la Lengua como medio esencial de la comunicación,a partir del análisis de sus unidades [\Usage].
   \item Diferenciar las características del código lingüístico oral y escrito, como medio primordial de comunicación [\Usage].
   \item Distinguir, valorar y aplicar las funciones del lenguaje como factor del conocimiento de la realidad y de las relaciones sociales. [\Usage].
   \item Incrementar su vocabulario a través de la investigación y consignación de palabras propias de la carrera elegida [\Usage].
\end{learningoutcomes}

\end{unit}

\begin{unit}{}{El estudio de las estructuras lingüísticas}{Cassany,Caceres,Cisneros,Hockett,Leahey,Saussure,Alonso}{9}{C17}
\begin{topics}
...
\end{topics}
\begin{learningoutcomes}
   \item Desarrollar la capacidad de abstracción y de relación a través del análisis de las estructuras lingüísticas [\Usage].
   \item Diferenciar las relaciones lógicas entre las ideas presentadas en los textos [\Usage].
   \item Construir en orden lógico, diversos tipos de textos empleando ideas principales y secundarias [\Usage].
   \item Analizar los contextos oracionales como elemento base de una expresión completa [\Usage].
   \item Desarrollar la competencia lingüística mediante la permanente ejercitación ortográfica, morfológica y sintáctica [\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{La Lectura como Comunicación Escrita}{Cassany,Caceres,Cisneros,Hockett,Leahey,Saussure,Alonso}{9}{C17}
\begin{topics}
...
\end{topics}
\begin{learningoutcomes}
   \item Aplicar y analizar las estructuras linguísticas, con el fin de asimilar y valorar textos [\Usage].
   \item Descubrir y manejar las diferentes estructuras de distintos discursos escritos [\Usage].
   \item Alcanzar el manejo adecuado de los procesos lógicos de síntesis [\Usage].
   \item Demostrar preocupación por la fase correctiva de la producción de textos [\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{La Redacción como comunicación escrita por uno mismo}{Cassany,Caceres,Cisneros,Hockett,Leahey,Saussure,Alonso}{9}{C17}
\begin{topics}
...
\end{topics}
\begin{learningoutcomes}
   \item Mejorar su redacción, formando en cuanta pauta y normas señaladas [\Usage].
   \item Elaborar textos empleando micro estructuras [\Usage].
   \item Iniciarse y/o perfeccionarse en la redacción del tipo administrativo o comercial [\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{El discurso Oral}{Cassany,Caceres,Cisneros,Hockett,Leahey,Saussure,Alonso}{9}{C17}
\begin{topics}
...
\end{topics}
\begin{learningoutcomes}
   \item Distinguir entre una comunicación oral en grupo pequeño y en público, aprendiendo a manejar la persuasión, a través de la argumentación en el discurso oratorio [\Usage].
   \item Reconocer y discriminar las ideas que estructuran los diferentes discursos oratorios [\Usage].
   \item Evidenciar y valorar las producciones orales, demostrando respeto y tolerancia por el emisor y su mensaje [\Usage].
   \item Producir diferentes discursos oratorios, aplicando las formas en que pueden estructurarse [\Usage].
\end{learningoutcomes}
\end{unit}
